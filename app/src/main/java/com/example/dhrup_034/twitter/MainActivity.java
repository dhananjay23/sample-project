...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String TWITTER_KEY = "67vQrNqc541S9nKySt4cnppaC";
    private static final String TWITTER_SECRET = "nGDytYFRxD14cn7RjmhGKqkibp9pAbtpWVSv27oFPn1vMRkAnj";
